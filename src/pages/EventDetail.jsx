        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-end pb-12">
          ...
          >
            ...
            <div className="mb-4 flex flex-wrap gap-2">
              ...
              {event.mode && (
                <span className="px-4 py-1 bg-cyan-500 text-black text-xs font-bold rounded-full capitalize">
                  {event.mode === 'online' ? '🌐 Online' : '📍 ' + event.mode}
                </span>
              )}
              <span className="px-4 py-1 bg-green-500 text-black text-xs font-bold rounded-full">
              ...
              <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-800 rounded-lg p-3">
                ...
                <p className="text-white text-sm font-bold">
                  {event.attendees}/{event.capacity}
                      ...
                      {/* CTA Button */}
        <button className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-500 to-teal-500 text-black font-bold rounded-lg hover:shadow-lg hover:shadow-cyan-500/50 transition-all text-lg">
          Register for Event
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-8 md:p-12 shadow-2xl mb-8">
            ...
            <div className="space-y-4">
              {event.speakers.map((speaker) => (
                ...
                >
                  <div className="flex-shrink-0 w-16 h-16 rounded-full bg-gradient-to-br from-cyan-500 to-teal-500 flex items-center justify-center text-black font-bold text-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {event.audience && (
            <div className="bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
              ...
              <p className="text-gray-300">{event.audience}</p>
            </div>
          )}
