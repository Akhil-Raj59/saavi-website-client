...
export default function ContactsAdmin() {
  ...
  const load = async (page = 1, status = filter) => {
    ...
    try {
      ...
      // Extract contacts array from nested structure
  ...
  const columns = [
    {
      ...
      render: (r) => (
        <div>
          ...
          {r.phone && (
            <div className="text-xs text-slate-400 mt-0.5">📞 {r.phone}</div>
          )}
        </div>
      )
    },
    ...
    },
    {
      ...
      render: (r) => {
        ...
        return (
          <span className={`inline-block px-2.5 py-1 text-xs font-medium rounded-full border ${statusColors[r.status] || "bg-slate-100 text-slate-800"}`}>
            {r.status}
          </span>
        );
      }
        ...
        <main className="p-6">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4">
              <div>
                <h2 className="text-2xl font-semibold text-slate-800">Contact Submissions</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-green-800">{getStatusCount("new")}</div>
                  <div className="text-xs text-slate-500">New Inquiries</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-blue-800">{getStatusCount("contacted")}</div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-gray-800">{getStatusCount("resolved")}</div>
          ...
          {loading ? (
            <div className="bg-white border rounded-lg p-8 text-center">
              ...
              <div className="mt-2 text-slate-600">Loading contacts...</div>
            </div>
          ) : contacts.length === 0 ? (
            <div className="bg-white border rounded-lg p-8 text-center">
